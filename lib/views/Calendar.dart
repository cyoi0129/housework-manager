...
class CalendarView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    _calendarData.setCalendarEvents(_masterData.getMasterList(), _taskData.getTaskList());

    return Scaffold(
      appBar: const Header(title: 'Calendar'),
      body: Column(mainAxisAlignment: MainAxisAlignment.start, mainAxisSize: MainAxisSize.max, crossAxisAlignment: CrossAxisAlignment.center, children: [
        TableCalendar(
            ...
            onFormatChanged: (format) => {_calendarData.setCalendarFormat(format)},
